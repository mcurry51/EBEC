...
pipe_diameter = float(input('Enter the pipe''s diameter: '))
pipe_temperature = float(input('Enter the temperature in °C as 5, 10, or 15: '))
if pipe_temperature == 5:
